...
Also, the summary shows that there are a lot of NA's in certain columns (e.g., borough) which could be difficult to use. We will visualize the data to find out more.
...
```{r}
# JB - - Is there any way to exclude the 00000 ZIP code from these charts? it destroyes the entire scale :/ 
